...
def alexnet_v2(inputs, num_classes=1000, is_training=True, dropout_keep_prob=0.5,
    ...
    """
    AlexNet version 2.  , global_pool=False
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.max_pool2d],
            ...
            with slim.arg_scope([slim.conv2d],
                ...
                if spatial_squeeze:
                    ...
                    net0 = tf.squeeze(net0, [1, 2], name='fc8_0/squeeze')
                    end_points[sc.name + '/fc8_0'] = net0
                    net1 = tf.squeeze(net1, [1, 2], name='fc8_1/squeeze')
                    end_points[sc.name + '/fc8_1'] = net1
                    net2 = tf.squeeze(net2, [1, 2], name='fc8_2/squeeze')
                    end_points[sc.name + '/fc8_2'] = net2
                    net3 = tf.squeeze(net3, [1, 2], name='fc8_3/squeeze')
